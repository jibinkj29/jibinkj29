        ...
        <div class="app-content main-content">
            <div class="side-app">
                ...
                <div class="page-header">
                    <div class="page-leftheader">
                        <h4 class="page-title mb-0 text-primary">Student Mark Adding</h4>
                    </div>
            ...
            <div class="btn-list">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Student Mark Adding</h3>
                            </div>
                            <div class="card-body">
                    ...
                    @endif
                                <form action="{{ route('marks.submit') }}"" method="post" enctype='multipart/form-data' >
                                @csrf
                                ...
                                <div class="col-sm-6 col-md-6">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="marks" value="" class="form-control"  placeholder="Mark">
                                        </div>
                                    </div>
